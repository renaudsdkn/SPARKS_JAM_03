...
image_f1.b.c = sfClock_create();
    ...
    image_f1.c.T = sfTexture_createFromFile("./src/Kevin/pictures_jam/dialog1.png", NULL);
    ...
    image_f1.d.T = sfTexture_createFromFile("./src/Kevin/pictures_jam/dialog2.png", NULL);
...
/**********phantom__2*/
    ...
    image_f1.f.T = sfTexture_createFromFile("./src/Kevin/Yurei/Attack_4.png", NULL);
